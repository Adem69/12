...
$dsn = 'mysql:host=localhost;dbname=ats_db';
$dbUser ='root';
$pw = '';
try {
  $connection = new PDO($dsn ,$dbUser,$pw);
  ...
  echo 'Connection failed:' . $e->getMessage();
   ...
   if (isset($_POST['Create'])) {
     ...
     if (isset ($_POST['project'], $_POST['issueType'] , $_POST['summary'] , $_POST['lot'] , $_POST['phase'] , $_POST['priority'] , $_POST['duedate'] 
        , $_POST['module'] , $_POST['reporter'] , $_POST['assignee'] , $_POST['environment'] , $_POST['description']  ) ) 
         {
         	


          if ($_POST['project']!="" && $_POST['issueType']!="" && $_POST['summary']!="" && $_POST['lot']!="" && $_POST['phase'] !="" && $_POST['priority'] !="" && $_POST['module'] !="" && 
             $_POST['reporter'] !="" && $_POST['assignee'] !="" && $_POST['environment'] !="" && $_POST['description'] !="" ) {

            $insertion = "INSERT INTO issue (project,issueType , summary , lot , phase , priority , date , module , reporter , assignee , environment , description) VALUES ('$_POST[project]',' $_POST[issueType] ', '$_POST[summary]' ,' $_POST[lot]' , '$_POST[phase]' , '$_POST[priority]' ,' $_POST[duedate]' ,' $_POST[module] ', '$_POST[reporter] ',' $_POST[assignee]' ,' $_POST[environment]' , '$_POST[description]')";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" method="POST" action="tickets.php">
          ...
          <div class="col-md-6 mb-3">
            <label for="firstName">Project*</label>  
             <select class="form-control" name="project">
              <option value="NASDAQ">NASDAQ-HERMES (HERMES)</option>
              <option>Implementation of service desk</option>
              <option>Upgrade of Software</option>
            </select>
        ...
        <div class="mb-3">
          <label for="address2">Priority<span class="text-muted">(Optional)</span></label> 
             <select class="form-control" name="priority" required="">
              ...
              <option value="Medium">blocker</option>
              <option value="Medium">Major</option>
              <option value="Difficult">Minor</option>
            </select>
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <select class="custom-select d-block w-100" id="module" name="module" required="">
              ...
              <option value="California">Paie Management

</option>
              <option value="TEST">Human resource management
          ...
          <label for="state">Assignee </label>     
            <input type="text" name="assignee" class="custom-select d-block w-100" id="assignee" required="">
