  ...
  <body>
    ...
    <header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="index2.html">Fitness city<span></span></a>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav mr-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="member.html">Body Builder</a>
                  <a class="dropdown-item" href="member.html">Dance</a>
                  <a class="dropdown-item" href="member.html">Cardio</a>
                </div>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="member.html">News</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="contact2.html">Contact</a>
              </li>
                 <li>
              <a class="nav-link" href="member.html" >Shop</a>
              </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item cta-btn">
                <a class="nav-link" href="member.html">Became a member</a>
              </li>
            </ul>
           ...
           ?>
              ...
              <div>
                <div class="media d-block media-custom text-center"> 
                  ...
                  <span><?php echo $row ['nomprenom']; ?> </span>
          ...
          <div class="col-md-5 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              <li class="d-block">
                ...
                <span class="text-white">El mourouj 6,Ben arous</span></li>
              <li class="d-block"><span class="d-block">Telephone:</span><span class="text-white">+216 25 990 976</span></li>
              <li class="d-block"><span class="d-block">Email:</span><span class="text-white">azizgaid@gmail.com</span></li>
            </ul>
          </div>
